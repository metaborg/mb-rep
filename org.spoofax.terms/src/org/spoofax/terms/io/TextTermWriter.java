 ...
 * Default term writer.
 *
 * Override member of this class to influence term writing.
 * Overriding implementation should make sure to call {@link #writeTerm} to write subterms,
 * as this method check the depth and writes the annotations and attachments, if applicable.
 */
public class TextTermWriter implements TermWriter {

    /** Singleton instance of the term writer. */
    /* package private */ static final TextTermWriter INSTANCE  = new TextTermWriter();
     ...
     */
    public TextTermWriter(int maxDepth) {
     ...
     */
    public TextTermWriter(int maxDepth, boolean ignoreAnnotations, boolean ignoreAttachments) {
     ...
     */
    public TextTermWriter(int maxDepth, boolean ignoreAnnotations, boolean ignoreAttachments, boolean ignoreListTailAttributes, boolean ignoreAnnotationAttributes) {
    ...
    protected void writeAnnotations(IStrategoTerm term, Appendable writer, int depth, boolean isAnnotation) throws IOException {
        ...
        if(depth <= 1 || annos.isEmpty()) { return; }
    ...
    protected void writeAttachments(IStrategoTerm term, Appendable writer, int depth, boolean isAnnotation) throws IOException {
        ...
        if(depth <= 1 || attachment == null) { return; }
