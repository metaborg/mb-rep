...
public class ATermParseControllerGenerated extends DynamicParseController 
{ 
  ...
  { 
    ATermParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = ATermParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = ATermParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(ATermParseControllerGenerated.class);
    }
