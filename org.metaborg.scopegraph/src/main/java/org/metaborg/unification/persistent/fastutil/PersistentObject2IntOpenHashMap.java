...
public final class PersistentObject2IntOpenHashMap<K> implements PersistentObject2IntMap<K> {
    ...
    @Override
    public PersistentObject2IntMap<K> put(K key, int value) {
        return reroot().put(this,key,value);
    }
 
    @Override
    public PersistentObject2IntMap<K> remove(K key) {
    ...
    private static class Store<K> implements Inner<K>  {
        private final it.unimi.dsi.fastutil.objects.Object2IntMap<K> store =
                new it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap<K>();
