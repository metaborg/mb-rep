...
public class LANG_index_get_one_pair extends AbstractPrimitive {
	private static String NAME = "LANG_index_get_one_pair";

	public LANG_index_get_one_pair() {
		super(NAME, 0, 1);
	}
	...
	public boolean call(IContext env, Strategy[] svars, IStrategoTerm[] tvars) {
		...
		env.setCurrent(index.entryFactory().toPair(entry));
		return true;
	}
}
